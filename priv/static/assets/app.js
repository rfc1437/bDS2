...
`
  ...
  var createMenuRuntimeCommandRunner = ({ activeMonacoEditor, runMonacoEditorAction, runDocumentCommand, applyAppZoom }) => {
    return (action) => {
    ...
    const Hooks2 = {
      ...
      MonacoEditor: {
        mounted() {
          ...
          monacoServices.loadMonaco().then(async (monaco) => {
